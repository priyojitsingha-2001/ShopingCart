...
export default function CartPage() {
    ...
    return (
        <div>
            ...
            <div className="">
                {items.map(item => (
                    <div className='bg-slate-100 my-1 shadow-lg rounded-md py-3 px-4 flex justify-between' key={item.id}>
                        <div className="flex">
                ...
                {totalPrice != 0 ? <p className='text-right py-4 font-bold text-gray-700'>Total: {totalPrice}$</p> :
